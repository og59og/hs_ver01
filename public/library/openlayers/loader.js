...
(function() {
  ...
  if (!raw) {
    document.write('<scr' + 'ipt type="text/javascript" src="/library/openlayers/build/ol.js"></scr' + 'ipt>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="/library/openlayers/closure-library/closure/goog/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="/library/openlayers/build/ol-deps.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="/library/openlayers/' + scriptId + '-require.js"></scr' + 'ipt>');
  }
  document.write('<scr' + 'ipt type="text/javascript" src="/library/openlayers/' + scriptId + '.js"></scr' + 'ipt>');
}());
